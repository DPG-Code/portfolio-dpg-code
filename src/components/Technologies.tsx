...
const ICON_TECH = {
  nextjs: () => {
    return (
      <svg className="w-6 h-6 lg:w-12 lg:h-12" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
  ...
  deno: () => {
    return (
      <svg className="w-6 h-6 lg:w-12 lg:h-12" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M13.47 20.882l-1.47 -5.882c-2.649 -.088 -5 -1.624 -5 -3.5c0 -1.933 2.239 -3.5 5 -3.5s4 1 5 3c.024 .048 .69 2.215 2 6.5"></path>
